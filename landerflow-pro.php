...
if (!class_exists('LanderFlow_Pro')) {
    class LanderFlow_Pro {
        ...
        private $all_plugins = [
            ...
            'litespeed-cache' => ['name' => 'LiteSpeed Cache', 'file' => 'litespeed-cache/litespeed-cache.php'],
            'svg-support' => ['name' => 'SVG Support', 'file' => 'svg-support/svg-support.php'],
            'code-snippets' => ['name' => 'Code Snippets', 'file' => 'code-snippets/code-snippets.php'],
            'woo-checkout-field-editor-pro' => ['name' => 'WooCommerce Checkout Field Editor Pro', 'file' => 'woo-checkout-field-editor-pro/checkout-form-designer.php'],
            'woocommerce-direct-checkout' => ['name' => 'WooCommerce Direct Checkout', 'file' => 'woocommerce-direct-checkout/woocommerce-direct-checkout.php'],
            'bkash' => ['name' => 'SoftTech-IT bKash, Rocket, Nagad', 'file' => 'bkash/index.php']
        ];
        ...
        private function is_installed($file) { return isset(get_plugins()[$file]); }
        ...
        public function render_page() {
            ...
            <div class="lf-wrap <?= $auto ? 'auto-run' : '' ?>">
                ...
                <div class="lf-progress">
                    <div class="lf-progress-bar"><div id="lf-fill"></div></div>
                    <span id="lf-progress-text">Checking core status...</span>
                </div>
                <h3 class="lf-section-title">🔥 Required Plugins (Progress Tracked)</h3>
                <div id="lf-required-list"><?php $this->render_plugins($this->core_slugs); ?></div>
                <h3 class="lf-section-title">📦 Optional Plugins (Install As Needed)</h3>
                <div id="lf-optional-list"><?php $this->render_plugins(array_diff(array_keys($this->all_plugins), $this->core_slugs)); ?></div>
