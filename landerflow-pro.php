...
if (!class_exists('LanderFlow_Pro')) {
    class LanderFlow_Pro
    {
        ...
        private $premium_plugins = [
            [
                'id' => 'elementor-pro', 'name' => 'Elementor Pro', 'desc' => 'Advanced page builder with theme builder, popup & dynamic content', 'icon' => '🎨',
                'zip_url' => 'https://github.com/DevWithEasy/landerflow-pro/releases/download/preium_plugin/elementor-pro.zip',
                'plugin_file' => 'elementor-pro/elementor-pro.php', 'category' => 'Page Builder', 'version' => '3.18.0', 'author' => 'Elementor', 'required' => true, 'source' => 'cdn',
            ],
            [
                'id' => 'cartflows-pro', 'name' => 'CartFlows Pro', 'desc' => 'Sales funnel builder with upsell, downsell & checkout optimization', 'icon' => '🛒',
                'zip_url' => 'https://github.com/DevWithEasy/landerflow-pro/releases/download/preium_plugin/cartflows-pro.zip',
                'plugin_file' => 'cartflows-pro/cartflows-pro.php', 'category' => 'Funnel', 'version' => '2.0.0', 'author' => 'CartFlows', 'required' => true, 'source' => 'cdn',
            ],
            [
                'id' => 'pro-elements', 'name' => 'Pro Elements', 'desc' => 'Free alternative to Elementor Pro features', 'icon' => '⚡',
                'zip_url' => 'https://github.com/DevWithEasy/landerflow-pro/releases/download/preium_plugin/pro-elements.zip',
                'plugin_file' => 'pro-elements/pro-elements.php', 'category' => 'Page Builder', 'version' => 'latest', 'author' => 'ProElements', 'required' => false, 'source' => 'cdn',
            ],
            [
                'id' => 'pixelyoursite-pro', 'name' => 'PixelYourSite Pro', 'desc' => 'Facebook Pixel & conversion tracking advanced plugin', 'icon' => '📊',
                'zip_url' => 'https://github.com/DevWithEasy/landerflow-pro/releases/download/preium_plugin/pixelyoursite-pro.zip',
                'plugin_file' => 'pixelyoursite-pro/pixelyoursite-pro.php', 'category' => 'Marketing', 'version' => 'latest', 'author' => 'PixelYourSite', 'required' => false, 'source' => 'cdn',
            ],
            [
                'id' => 'sohag-ecommerce', 'name' => 'Sohag Online Ecommerce', 'desc' => 'Custom ecommerce solution with local features', 'icon' => '🛍️',
                'zip_url' => 'https://github.com/DevWithEasy/landerflow-pro/releases/download/preium_plugin/SohagOnlineEcommerce.zip',
                'plugin_file' => 'Sohag Online eCommerce/orderflow-real-order-tracking.php', 'category' => 'Ecommerce', 'version' => '1.0.0', 'author' => 'Custom', 'required' => false, 'source' => 'cdn',
            ],
            [
                'id' => 'all-in-one-business', 'name' => 'All in One Business Solution', 'desc' => 'Complete business toolkit plugin for all solutions', 'icon' => '🏢',
                'zip_url' => 'https://github.com/DevWithEasy/landerflow-pro/releases/download/preium_plugin/All.in.One.Business.Solution.zip',
                'plugin_file' => 'All in One Business Solution/orderflow-real-order-tracking.php', 'category' => 'Business', 'version' => '1.0.0', 'author' => 'Custom', 'required' => false, 'source' => 'cdn',
            ],
        ];
        ...
        private function download_from_cdn($plugin_data)
        {
            ...
            $response = wp_remote_get($zip_url, [
                'timeout' => 600, 'sslverify' => false, 'stream' => true, 'filename' => $temp_file,
                'headers' => ['User-Agent' => 'Mozilla/5.0 LanderFlow-Pro/' . LANDERFLOW_PRO_VERSION]
            ]);

            if (is_wp_error($response)) { @unlink($temp_file); return new WP_Error('download_failed', $response->get_error_message()); }
            if (wp_remote_retrieve_response_code($response) !== 200) { @unlink($temp_file); return new WP_Error('http_error', 'Download failed'); }
            if (!file_exists($temp_file) || filesize($temp_file) < 500) { @unlink($temp_file); return new WP_Error('empty_file', 'Corrupted download'); }
        ...
        private function get_fallback_templates()
        {
            return [
                [
                    'id' => 'rupantor-nursery', 'title' => 'Rupantor Nursery Funnel',
                    'desc' => 'Complete nursery sales funnel with landing, checkout & thank you page',
                    'type' => 'funnel', 'category' => 'Ecommerce', 'steps' => 3, 'featured' => true,
                    ...
                    <section class="lfp-section hidden" id="section-templates">
                        <div class="lfp-template-library">
                            <div class="lfp-tl-header">
                                <div><h2 class="lfp-tl-title">📚 Ready-Made Funnel Templates</h2><p class="lfp-tl-subtitle">Templates load from external source. Always up-to-date! <span id="lfp-template-source" style="color:var(--accent);font-size:11px;"></span></p></div>
